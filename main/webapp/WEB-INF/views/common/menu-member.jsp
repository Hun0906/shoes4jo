...
<li><a class="dropdown-item" onclick="location.href='<%=context%>/bookmarkcon/list.do'">❤️즐겨찾기</a></li>
<li><a class="dropdown-item" onclick="location.href='<%=context%>/freeboard/list.do'">✏️작성 글</a></li>
