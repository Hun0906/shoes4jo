...
function getAPIResult() {
    ...
    var resultData = ''; // 차트생성에 써야 해서 전역으로 선언
...
<div class="contents">
	...
	<%String keyword = request.getParameter("keyword"); %>
		<input type="text" class="main_search" id="keyword" value="<%(keyword == null)? "": keyword%>">
	...
	<a target="_blank" href="https://developers.naver.com/docs/common/openapiguide/errorcode.md#%EC%A3%BC%EC%9A%94-%EC%98%A4%EB%A5%98-%EC%BD%94%EB%93%9C">오류 코드</a>
...
function jsonParse(target){
	...
	let data = resultData.results[0].data;
