 ...
 * 
 * public class LogVO { private int id; private StoreVO store; private
 * StoreStateVO state; private Timestamp logDate;
 * 
 * public LogVO() {}
 * 
 * public LogVO(int id, StoreVO store, StoreStateVO state, Timestamp logDate) {
 * this.id = id; this.store = store; this.state = state; this.logDate = logDate;
 * }
 * 
