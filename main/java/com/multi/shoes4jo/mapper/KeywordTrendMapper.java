...
public interface KeywordTrendMapper {
    ...
    @Select("SELECT * FROM `4jo_api_search_gender` WHERE keyword = #{keyword} and gender = #{gender}")
    List<KeywordTrendVO> selectGen(@Param("keyword") String keyword, @Param("gender") String gender);
    
    @Select("SELECT * FROM `4jo_api_search_ages` WHERE keyword = #{keyword} and age = #{age}")
    ...
    int isExistsAge(@Param("period_sdata") String period_sdata, @Param("keyword") String keyword, @Param("gender") int age);
    ...
    int oldRatioAge(@Param("period_sdata") String period_sdata, @Param("keyword") String keyword, @Param("gender") int age);
