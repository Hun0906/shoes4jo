...
public interface GoodsDetailMapper {
	...
	@Select("SELECT a.* FROM goods_detail a JOIN (SELECT keyword, MIN(gno) as min_gno FROM goods_detail GROUP BY keyword) b ON a.keyword = b.keyword AND a.gno = b.min_gno ORDER BY gno ASC")
