...
public class CategoryTrendVO {
	...
	public CategoryTrendVO(String period_sdata, String keyword, int ratio_cnt) {
		this.period_sdata = period_sdata;
		this.keyword = keyword;
		this.ratio_cnt = ratio_cnt;
	}
	
	public CategoryTrendVO(String period_sdata, String keyword, int age, int ratio_cnt) {
		this.period_sdata = period_sdata;
		this.keyword = keyword;
		this.age = age;
		this.ratio_cnt = ratio_cnt;
